...
<center class="wrapper">
                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td class="padded">
                          ...
                          <p style="-moz-box-shadow:inset 0px 1px 0px 0px #cf866c;
	...
	padding:6px 24px;
	text-decoration:none;
	text-shadow:0px 1px 0px #854629;"><a href="http://quiz-app-total.herokuapp.com/" class="btn">ACTIVATE USER</a></p>
                         
                          <p class="caption">With Regards.</p>
                        </td>
                    </tr>
                    </tbody>
                </table>
